...
🔖 _${timeWit} Wit_ ⏰`   
        ...
        buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: '🚦ALL MENU BOT'},type:1},{buttonId:`${prefix}owner`,buttonText:{displayText:'👑 OWNER'},type:1},{buttonId: `${prefix}sc`,buttonText:{displayText: '🗿 PROMOSI'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
        ...
        prep = await denz.prepareMessageFromContent(from,{buttonsMessage},{quoted: ftrol, contextInfo:{"forwardingScore":999,"isForwarded":true, "mentionedJid": [ptod,dtod,otod,stod],"externalAdReply": {"title": `Hai Kak ${pushname}👋🏻`, mediaType: 2, "thumbnailUrl": "https://e.top4top.io/p_2093slqss0.jpg","previewType": "VIDEO","mediaUrl": `https://youtu.be/rb-s_oRL5Ww`, sendEphemeral: true}}})
...
*ꪶ𖣂ꫂ‎‎‎ MENU 1ꪶ𖣂ꫂ‎‎‎*   
*_PILIH MENU DI BAWAH YA_*
_kalo tidak muncul button nya ketik_ #allmenu`   
                        //abw
        buttons = [{buttonId: `${prefix}ownermenu`,buttonText:{displayText: 'OWNER+WAR MENU'},type:1},{buttonId:`${prefix}downloadmenu`,buttonText:{displayText:'️MENU DOWNLOAD'},type:1},{buttonId: `${prefix}abw`,buttonText:{displayText: '↪MENU SELANJUTNYA'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
...
PILIH MENU DI BAWAH YA`   
                        //abw
        buttons = [{buttonId: `${prefix}makermenu`,buttonText:{displayText: 'MAKER MENU'},type:1},{buttonId:`${prefix}groupmenu`,buttonText:{displayText:'GROUP MENU'},type:1},{buttonId: `${prefix}abww`,buttonText:{displayText: '↪MENU SELANJUTNYA'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
...
PILIH MENU DI BAWAH YA`   
                        //abw
        buttons = [{buttonId: `${prefix}nsfwmenu`,buttonText:{displayText: '18 MENU'},type:1},{buttonId:`${prefix}othermenu`,buttonText:{displayText:'OTHER MENU'},type:1},{buttonId: `${prefix}akunff`,buttonText:{displayText: 'BELI AKUN FF'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
...
*ꪶ𖣂ꫂ‎‎‎ BELI AKUN FFꪶ𖣂ꫂ‎‎‎*   
PILIH MENU AKUN FF INI YA
*_hanya percobaan_*`   
                        //abw
        buttons = [{buttonId: `${prefix}akunff1`,buttonText:{displayText: 'AKUN FF S 1'},type:1},{buttonId:`${prefix}akunff2`,buttonText:{displayText:'AKUN FF S 2'},type:1},{buttonId: `${prefix}akunff3`,buttonText:{displayText: 'AKUN FF S 3'},type:1},{buttonId: `${prefix}sosmed`,buttonText:{displayText: '🔰SOSMED'},type:1}]
...
////////////////case akun ff//////////////
case 'akunff1':
              const abwe =['cuman tes kok']
              const abw = abwe[Math.floor(Math.random() * abwe.length)]
              buffer = await getBuffer(`https://j.top4top.io/p_21011rcos0.jpg`)
              denz.sendMessage(from, buffer, image, { quoted: mek, caption: '*akun ff seasson 1*\n\n'+ abw })
              break
case 'akunff2':
              const abwea =['elit pas 8 .harga 500an akun seasson 2 ']
              const abww = abwea[Math.floor(Math.random() * abwea.length)]
              buffer = await getBuffer(`https://j.top4top.io/p_21011rcos0.jpg`)
              denz.sendMessage(from, buffer, image, { quoted: mek, caption: '*akun ff seasson 2*\n\n'+ abww })
              break
case 'akunff3':
              const akun =['elit pas 8 .harga 500an akun seasson 2 ']
              const ff = akun[Math.floor(Math.random() * akun.length)]
              buffer = await getBuffer(`https://j.top4top.io/p_21011rcos0.jpg`)
              denz.sendMessage(from, buffer, image, { quoted: mek, caption: '*akun ff seasson 3*\n\n'+ ff })
              break
//button
case 'babi':
 listMsg = {
